...
format:
  revealjs:
    ...
    include-in-header:
      text: |
        <link rel='stylesheet' type='text/css' href='https://cdn.jsdelivr.net/gh/dreampulse/computer-modern-web-font@master/fonts.css'><link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin=""/>
...
## Ethical Framework Implicit in Learning "Who You Are"! {.smaller .crunch-title .title-09 .crunch-quarto-figure}
...
## Now With Fake Jeff Bio {.crunch-title .crunch-img .smaller}
...
## Normalizing Counts {.crunch-title .crunch-img .smaller}
...
## <mark data-term="Рівність Чого?">Equality of What?</mark> {.crunch-title .crunch-ul .math-80 .title-09 .text-90}
...
## Background: Indochina Mine Defusal {.crunch-title .title-09 .text-90}
...
![From @shahid_comparison_2009](images/medical_distances.jpg){fig-align="center" width="70%"}
